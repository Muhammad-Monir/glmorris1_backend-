                                    ...
                                    <div class="grid grid-cols-1 gap-5 lg:grid-cols-2 xl:grid-cols-12">
                                        ...
                                        <div class="xl:col-span-6">
                                            ...
                                            <input type="text" id="productNameInput"
                                                ...
                                                name="title" placeholder="Item title" required>
                                            @error('title')
                                        ...
                                        <div class="xl:col-span-6">
                                            ...
                                            <input type="text" id="productCodeInput"
                                                class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200"
                                                name="product_number" placeholder="TWT145015" required>
                                        ...
                                        <div class="xl:col-span-6">
                                            ...
                                            <input type="text"
                                                class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200"
                                                name="tog_value" placeholder="Thermal Overall Grade Value" required>
                                            @error('tog_value')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                        ...
                                        <div class="xl:col-span-6">
                                            ...
                                            <input type="text"
                                                class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200"
                                                name="brand" placeholder="Brand Name" required>
                                            @error('brand')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                        ...
                                        <div class="lg:col-span-2 xl:col-span-12">
                                            <label for="genderSelect"
                                                class="inline-block mb-2 text-base font-medium">Product Images</label>
                                            <div class="custom-file-input">
                                                <input type="file" id="fileInput" class="file-input"
                                                    onchange="previewFile()" name="image" />
                                                <label for="fileInput" class="file-label">Drag and drop your product images
                                                    or <a href="#!">browse</a>
